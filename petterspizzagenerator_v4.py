...
#
pizzanavn = ['"La Rosa"','"Petters Spesial"','"Turbo Spesial"','"Toni Spesial"','"Capricho"','"Olivera"','"Campera"','"Taco Pizza"','"La Napolitana"','"El Toro"','"La Pepperoni"','"Martita"','"Vegetar"','"Nidelv Spesial"','"Kebab Pizza"']
